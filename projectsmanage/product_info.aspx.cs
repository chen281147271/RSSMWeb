...
{
    public partial class product_info : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ValidateAuth("p006");
            btn_add.OnClientClick = Window1.GetShowReference("~/projectsmanage/product_info_new.aspx", "新增");
        ...
        {
            return Utils.GetUserName(Convert.ToInt32(id));
        }
        ...
        protected DataTable GetDataTable()
        {
            ...
            sql += " where pd_name like '%" + txt_username.Text + "%'";
        ...
        {
            return Window1.GetShowReference("~/projectsmanage/product_info_new.aspx?id=" + id, "编辑 - " + name);
        }
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sql = "delete from pjm_product_info where pd_id in (" + sb.ToString().TrimEnd(',') + ");";
