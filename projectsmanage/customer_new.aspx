<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="customer_new.aspx.cs" Inherits="RSSMWeb.projectsmanage.customer_new" %>
            ...
            <ext:Panel ID="Panel2" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" >
                <Items>
                    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true"
                        ...
                        <Items>
                            <ext:TextBox ID="txt_cusname" Label="客户名" runat="server" Required="true" ShowRedStar="true"  />
                            <ext:TextBox ID="txt_cuscontact" Label="联系人" runat="server" Required="false" ShowRedStar="false" />   
                            <ext:TextBox ID="txt_cusaddress" Label="客户所在地" runat="server" Required="false" ShowRedStar="false"  /> 
