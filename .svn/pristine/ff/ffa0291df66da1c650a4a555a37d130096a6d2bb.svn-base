...
{
    public partial class agent : PageBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ValidateAuth("p004");
            btn_add.OnClientClick = Window1.GetShowReference("~/projectsmanage/agent_new.aspx", "新增");
        ...
        protected DataTable GetDataTable()
        {
            ...
            sql += " where agent_name like '%" + txt_username.Text + "%'";
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                sql = "delete from sys_agent where agent_id in (" + sb.ToString().TrimEnd(',') + ");";
