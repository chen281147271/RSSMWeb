...
namespace RSSMWeb.systemmanage
{
    public partial class WebForm1 : PageBase
    {
        ...
        {
            ValidateAuth("s003");
            btn_add.OnClientClick = Window1.GetShowReference("~/systemmanage/user_new.aspx", "新增");
        ...
        {
            Page.Session["type"] = "1";
            return Window1.GetShowReference("~/systemmanage/User_new.aspx?id=" + id + "&编辑 - " + name);
        }
         ...
         protected DataTable GetDataTable()
         {
             ...
             string sql = "select * from sys_user a,sys_organize_info b where a.org_id=b.org_id ";
             sql += " and user_name like '%" + txt_username.Text + "%'";
